////////////////////////////////////////////////////////////////////////////////
//  Author: Florian Tschopp <ftschopp@ethz.ch>, April 2019
//  Modify: Lin Zhao <linzhao@uri.edu>
////////////////////////////////////////////////////////////////////////////////
...
void Synchronizer::imageCallback( const synchronizer_ros::ImageNumbered &image_msg) {
  ...
  if (initialized_) {
    ...
    // Note: The time message should arrive prior to the image.
...
/******************** synchronizer_arduino side ********************/ 
  ...
  if (!nh_private_.getParam("synchronizer_topic", synchronizer_topic_)) {
    ...
    image_time_sub_topic_ = synchronizer_topic_ + "time";
